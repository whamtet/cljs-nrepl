...
cljs_nrepl.core.my_eval = (function cljs_nrepl$core$my_eval(p__15061){
var map__15065 = p__15061;
...
var source = cljs.core.get.call(null,map__15065__$1,new cljs.core.Keyword(null,"source","source",-433931539));
...
return realise.call(null,cljs.core.pr_str.call(null,p1__15068_SHARP_));
...
cljs.core._add_method.call(null,cljs_nrepl.core.op_handle,"clone",(function (p__15071,cookie_session){
...
var session = cljs.core.get.call(null,map__15072__$1,new cljs.core.Keyword(null,"session","session",1008279103));
var id = cljs.core.get.call(null,map__15072__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
cljs.core._add_method.call(null,cljs_nrepl.core.op_handle,"close",(function (p__15074,cookie_session){
var map__15075 = p__15074;
var map__15075__$1 = ((((!((map__15075 == null)))?((((map__15075.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15075.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15075):map__15075);
var id = cljs.core.get.call(null,map__15075__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
return cljs_nrepl.core.response.call(null,cookie_session,id,cljs.core.PersistentArrayMap.EMPTY);
}));
cljs.core._add_method.call(null,cljs_nrepl.core.op_handle,"eval",(function (p__15077,cookie_session){
var map__15078 = p__15077;
var map__15078__$1 = ((((!((map__15078 == null)))?((((map__15078.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15078.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15078):map__15078);
var id = cljs.core.get.call(null,map__15078__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var code = cljs.core.get.call(null,map__15078__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var session = cljs.core.get.call(null,map__15078__$1,new cljs.core.Keyword(null,"session","session",1008279103));
...
return redlobster.promise.defer_until_realised.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [value], null),((function (value,map__15078,map__15078__$1,id,code,session){
return (function (){
...
});})(value,map__15078,map__15078__$1,id,code,session))
);
}));
cljs.core._add_method.call(null,cljs_nrepl.core.op_handle,new cljs.core.Keyword(null,"default","default",-1987822328),(function (p__15080,cookie_session){
var map__15081 = p__15080;
var map__15081__$1 = ((((!((map__15081 == null)))?((((map__15081.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15081.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15081):map__15081);
var op = cljs.core.get.call(null,map__15081__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
...
var params = cljs.core.get.call(null,map__15083__$1,new cljs.core.Keyword(null,"params","params",710516235));
var session = cljs.core.get.call(null,map__15083__$1,new cljs.core.Keyword(null,"session","session",1008279103));
...
return dogfort.middleware.routes.eval_route.call(null,request__5666__auto__,new cljs.core.Keyword(null,"get","get",1683182755),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["/"], null),(function (request__5666__auto____$1){
...
var len__5201__auto___15086 = arguments.length;
var i__5202__auto___15087 = (0);
while(true){
if((i__5202__auto___15087 < len__5201__auto___15086)){
args__5208__auto__.push((arguments[i__5202__auto___15087]));

var G__15088 = (i__5202__auto___15087 + (1));
i__5202__auto___15087 = G__15088;
continue;
} else {
}
break;
...
cljs_nrepl.core.main.cljs$lang$applyTo = (function (seq15085){
return cljs_nrepl.core.main.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15085));
});
