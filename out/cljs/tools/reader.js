...
var G__5379 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__5379;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__5381 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5381,ch);
...
if(("\\" === ch__$1)){
var ch_5382__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_5382__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_5382__$2);
} else {
}

var G__5383 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__5383;
continue;
}
}
...
var args5384 = [];
var len__5201__auto___5387 = arguments.length;
var i__5202__auto___5388 = (0);
while(true){
if((i__5202__auto___5388 < len__5201__auto___5387)){
args5384.push((arguments[i__5202__auto___5388]));

var G__5389 = (i__5202__auto___5388 + (1));
i__5202__auto___5388 = G__5389;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5384.length)].join('')));
...
if(cljs.core.truth_((function (){var or__4143__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__4143__auto__){
return or__4143__auto__;
} else {
var or__4143__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__5396 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var G__5397 = cljs.core.conj_BANG_.call(null,a,form);
a = G__5397;
continue;
}
}
...
var _STAR_read_delim_STAR_5399 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_5399;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__5402 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__5403 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5403,(0),null);
var end_column = cljs.core.nth.call(null,vec__5403,(1),null);
...
var vec__5406 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5406,(0),null);
var start_column = cljs.core.nth.call(null,vec__5406,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__5407 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5407,(0),null);
var end_column = cljs.core.nth.call(null,vec__5407,(1),null);
...
var vec__5410 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5410,(0),null);
var start_column = cljs.core.nth.call(null,vec__5410,(1),null);
...
var vec__5411 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5411,(0),null);
var end_column = cljs.core.nth.call(null,vec__5411,(1),null);
...
var sb = (function (){var G__5414 = (new goog.string.StringBuffer());
G__5414.append(initch);
...
var or__4143__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__5416 = (function (){var G__5415 = sb;
G__5415.append(ch);
...
switch (G__5424) {
case "\\":
var G__5428 = (function (){var G__5425 = sb;
G__5425.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__5425;
})();
var G__5429 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5428;
ch = G__5429;
continue;
...
break;
default:
var G__5430 = (function (){var G__5426 = sb;
G__5426.append(ch);

return G__5426;
})();
var G__5431 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5430;
ch = G__5431;
continue;
...
var vec__5433 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5433,(0),null);
var end_column = cljs.core.nth.call(null,vec__5433,(1),null);
...
var vec__5436 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5436,(0),null);
var column = cljs.core.nth.call(null,vec__5436,(1),null);
...
var or__4143__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
var vec__5445 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5445,(0),null);
var column = cljs.core.nth.call(null,vec__5445,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__4131__auto__ = line;
...
var vec__5448 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5448,(0),null);
var column = cljs.core.nth.call(null,vec__5448,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__5453 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5453,(0),null);
var start_column = cljs.core.nth.call(null,vec__5453,(1),null);
var start_column__$1 = (cljs.core.truth_(start_column)?((start_column - (1)) | (0)):null);
var the_set = cljs.core.set.call(null,cljs.tools.reader.read_delimited.call(null,"}",rdr,opts,pending_forms));
var vec__5454 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5454,(0),null);
var end_column = cljs.core.nth.call(null,vec__5454,(1),null);
...
var G__5456 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__5456,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_5458 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5458;
}});
...
var G__5460 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__5460,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__5460,rdr,first_line);

return G__5460;
} else {
var or__4143__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
var G__5465 = matched;
var G__5466 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__5465;
finished = G__5466;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__4131__auto__ = opts;
if(cljs.core.truth_(and__4131__auto__)){
...
var _STAR_suppress_read_STAR_5468 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__4143__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5468;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env5471 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__5472 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5472,"(");
...
var G__5473 = (i + (1));
var G__5474 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4143__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env5471;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__5476 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__5476);
...
var G__5479 = cljs.core.next.call(null,s);
var G__5480 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__5479;
key_vals = G__5480;
continue;
} else {
...
var or__4143__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
if((function (){var and__4131__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
...
))))):(cljs.core.truth_((function (){var or__4143__auto__ = (form instanceof cljs.core.Keyword);
if(or__4143__auto__){
return or__4143__auto__;
} else {
var or__4143__auto____$1 = typeof form === 'number';
if(or__4143__auto____$1){
return or__4143__auto____$1;
} else {
var or__4143__auto____$2 = typeof form === 'string';
if(or__4143__auto____$2){
return or__4143__auto____$2;
} else {
var or__4143__auto____$3 = (form == null);
if(or__4143__auto____$3){
return or__4143__auto____$3;
} else {
var or__4143__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__4143__auto____$4)){
return or__4143__auto____$4;
} else {
...
var gensym_env5488 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env5488;
}});
...
var temp__4423__auto__ = (function (){var or__4143__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__4143__auto__)){
return or__4143__auto__;
} else {
...
var args5495 = [];
var len__5201__auto___5499 = arguments.length;
var i__5202__auto___5500 = (0);
while(true){
if((i__5202__auto___5500 < len__5201__auto___5499)){
args5495.push((arguments[i__5202__auto___5500]));

var G__5501 = (i__5202__auto___5500 + (1));
i__5202__auto___5500 = G__5501;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5495.length)].join('')));
...
}catch (e5498){if((e5498 instanceof Error)){
var e = e5498;
...
var args5503 = [];
var len__5201__auto___5509 = arguments.length;
var i__5202__auto___5510 = (0);
while(true){
if((i__5202__auto___5510 < len__5201__auto___5509)){
args5503.push((arguments[i__5202__auto___5510]));

var G__5511 = (i__5202__auto___5510 + (1));
i__5202__auto___5510 = G__5511;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5503.length)].join('')));
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__5506,reader){
var map__5507 = p__5506;
var map__5507__$1 = ((((!((map__5507 == null)))?((((map__5507.cljs$lang$protocol_mask$partition0$ & (64))) || (map__5507.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5507):map__5507);
var opts = map__5507__$1;
var eof = cljs.core.get.call(null,map__5507__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args5513 = [];
var len__5201__auto___5516 = arguments.length;
var i__5202__auto___5517 = (0);
while(true){
if((i__5202__auto___5517 < len__5201__auto___5516)){
args5513.push((arguments[i__5202__auto___5517]));

var G__5518 = (i__5202__auto___5517 + (1));
i__5202__auto___5517 = G__5518;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5513.length)].join('')));
...
if(cljs.core.truth_((function (){var and__4131__auto__ = s;
if(cljs.core.truth_(and__4131__auto__)){
return !((s === ""));
} else {
return and__4131__auto__;
