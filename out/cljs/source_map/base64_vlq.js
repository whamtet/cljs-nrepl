...
var digit_6460 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_6461__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_6461__$1 > (0))){
var digit_6462__$1 = (digit_6460 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_6462__$1));

var G__6463 = (vlq_6461__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__6464 = (vlq_6461__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_6460 = G__6463;
vlq_6461__$1 = G__6464;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_6460));
}
break;
}
...
var G__6465 = i__$1;
var G__6466 = result__$1;
var G__6467 = shift__$1;
i = G__6465;
result = G__6466;
shift = G__6467;
continue;
